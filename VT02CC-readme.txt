...
This readme file, along with the change log and the data format specification
text files, will be replaced with online HTML documentation for the next major
release.
